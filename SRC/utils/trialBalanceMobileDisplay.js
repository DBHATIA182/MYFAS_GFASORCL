import { ledgerAccountCode as masterAccountCode } from './ledgerAccountCode';
import {
...
/** VARCHAR MASTER.CODE (e.g. O06004) — never coerce to number. */
export function trialAccountCode(row) {
  const code = masterAccountCode(row);
